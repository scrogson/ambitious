//! # starlang-gen-server
//!
//! GenServer pattern implementation for Starlang.
//!
...
//!
//! ```ignore
//! use starlang_gen_server::{GenServer, InitResult, CallResult, CastResult, From};
...
//!
//! ```ignore
//! use starlang_gen_server::{start, call, cast, stop};
...
pub use starlang_core::{ExitReason, Pid, Ref, Term};
