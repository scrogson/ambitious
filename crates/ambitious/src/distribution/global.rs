//! Global process registry for distributed Ambitious.
//!
...
/// ambitious::dist::global::register("my_service", pid);
/// ```
...
///
/// ```ignore
/// if let Some(pid) = ambitious::dist::global::whereis("my_service") {
///     ambitious::send_raw(pid, message);  // Works even if remote!
/// }
/// ```
