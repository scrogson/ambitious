//! Node identity types for distributed Ambitious.
//!
//! These types identify nodes in a Ambitious cluster:
//!
...
/// A node identifier.
///
/// Each node in a Ambitious cluster has a unique numeric ID. The local node
...
///
/// ```
/// use ambitious::core::node::{init_node, NodeName};
///
