...
//!
//! Terms are used throughout Ambitious for:
...
/// In Ambitious, any serializable Rust type can be a Term, giving you the same
/// flexibility with Rust's type safety.
///
/// # Examples
///
/// ```
/// use ambitious::core::Term;
